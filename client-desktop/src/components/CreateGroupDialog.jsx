...
export default function CreateGroupDialog({ onClose, friends, onRefresh }) {
    ...
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal-box">
        ...
        <div className="create-group" style={{ padding: '16px 20px 20px' }}>
          ...
          <div className="modal-actions" style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, paddingTop: 10 }}>
