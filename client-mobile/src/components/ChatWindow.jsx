      ...
      const loadDraft = () => {
        localMessageCache.getDraft(draftChat.type, draftChat.id)
          .then(draft => {
            ...
            const nextHasText = /\S/.test(draft);
